		...
		[
			...
			function (_p2) {
				...
				return A2(
					...
					'a',
					A2(_elm_lang$core$String$left, 1, 'abcdefg'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			...
			function (_p4) {
				var _p5 = _p4;
				return _elm_community$elm_test$Expect$fail('failed as expected!');
			})
		]));
...
var _user$project$Main$main = {
	main: A2(_rtfeldman$node_test_runner$Test_Runner_Node$run, _user$project$Main$emit, _user$project$Tests$all),
